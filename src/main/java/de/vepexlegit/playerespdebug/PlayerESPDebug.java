package de.vepexlegit.playerespdebug;

import de.vepexlegit.playerespdebug.commands.PlayerESPCommand;
...
@Mod(modid = "playerespdebug", version = "1.0")
public class PlayerESPDebug {
    @EventHandler
    public void preInit(FMLPreInitializationEvent event) {
        MinecraftForge.EVENT_BUS.register(this);
        ClientCommandHandler.instance.registerCommand(new PlayerESPCommand());
    }
    ...
    public void onRenderWorldLast(RenderWorldLastEvent event) {
        ...
        for (EntityPlayer player : Minecraft.getMinecraft().theWorld.playerEntities) {
            if (PlayerESP.INSTANCE.isEnabled()) {
